        ...
        >
          ...
          <div className="w-full md:w-1/2 space-y-4 pr-12">
            ...
            <p className="text-md mt-2">
              ...
              other consumers, which can then verify that the data has not been
              modified. Cryptographic operations can be efficiently computed to
  ...
  "signerPublicKey": "NnGAciO/OIz+R5aYBlTUb+QwCgD5xossqB8gZtKLOxs"
        ...
        <section id="what-you-can-do" className="p-6 bg-white">
          ...
          <p className="text-md mt-4">
            Unlike traditional data received from Web APIs, PODs can be saved by
            users and sent to other consumers without losing their integrity.
            The signature of a POD enforces that the content has not been
            modified. Data can now be moved across different websites and
            devices and remain self-verifying.
          </p>
          <h2 className="text-2xl font-semibold mt-8">
          ...
          <p className="text-md mt-4">
            ...
            devices like mobile phones & embedded systems. They can be redacted,
            transformed, and aggregated in a provable way, enabling data to
            cross trust boundaries.
          </p>
          <p className="text-md mt-4">
            This means that services issuing PODs do not need to predict ahead
            of time all use cases for their data. Instead, a POD can be ingested
            by cryptographic gadgets to create “just-in-time” APIs whose
          ...
          <li className="text-md mt-2">
            Show a loan provider that I am earning more than X dollars a year
            from my paystub
          </li>
          <li className="text-md mt-2">
          ...
          <p className="text-md mt-4">
            ...
            paystubs, government identities, ticketing systems — and prove to
            third-party Internet services that a subset of this data is correct,
            optionally with some logic applied to it. This primitive enables
            just enough information to be handed to a data consumer.
          </p>
          <p className="text-md mt-4">
            As an example, a loan provider can verify a proof of income via a
            cryptographic proof on a PODified paystub. Most of the paystub data
            can be redacted, and the total salary can be shown to be above a
            specific threshold without revealing the actual amount.
          </p>
        </section>
